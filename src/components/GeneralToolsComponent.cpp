...
GeneralToolsComponent::GeneralToolsComponent(BakkesMod::Plugin::BakkesModPlugin *plugin)
        : PluginComponent(plugin), currentGameState(), boostMutator(BoostMutator::None), airRollMutator(AirRollMutator::None)
{

}
std::string GeneralToolsComponent::title()
{
...
//    ImGui::Text("General tools including current game state, mutators, and analysis tools.");
//
...
void GeneralToolsComponent::onEvent(std::string eventName, bool post, void *params)
{
